...
help.
"""
# ignore annoying depreciation warnings from scikit-learm
...
def tokenize(doc, keep_internal_punct=False):
    ...
    ###TODO
    # pass
    excl_underscore = punctuation.replace("_","")
    if(keep_internal_punct): # Retain punctuation inside of a word
      # text = ' '.join(filter(None, (word.strip(excl_underscore) for word in doc.split())))
      # tokens = str.split(text.lower())
      # return np.array(tokens, dtype="unicode")
      for word in doc.split():
        a = word.strip(excl_underscore)
        print(a)
    else: # return alphanumerics 
      pass
...
def main():
    ...
    print(tokenize("Hi there, isn't_this fun?", keep_internal_punct=True))
